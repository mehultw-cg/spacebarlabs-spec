...
export const termsOfService = {
  ...
  intro: (
    <>
      <strong>Built on trust, clarity, and shared responsibility.</strong>
      <br /><br />
      Our Terms of Service define a transparent partnership model. We provide secure engineering, advisory, and implementation services based on industry best practices, while empowering clients with full ownership, documentation, and knowledge transfer.
      <br /><br />
      We do not vendor-lock clients. We provide the tools, systems, and training needed for long-term independence.
    </>
  ),
  sections: [
    {
  ...
  legalDisclaimers: [
    ...
    },
    {
      ...
      content: (
        <>
          Our goal is to build transparent partnerships based on trust, clarity, and shared accountability. We prioritize equipping clients with the knowledge and tools needed to maintain secure systems independently.
        </>
      )
    }
  ]
...
export const cookiePolicy = {
  ...
  intro: (
    <>
      <strong>We use minimal cookies, only when necessary.</strong>
      <br /><br />
      Unlike most websites, we avoid tracking and behavioral profiling. Any cookies used are strictly for essential functionality, security protection, or privacy-respecting analytics. We do not use advertising trackers or third-party data brokers.
      <br /><br />
      Your browsing experience should not come at the cost of your privacy.
    </>
  ),
  sections: [
    {
