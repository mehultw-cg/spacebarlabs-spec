...
const lightVariants: Variants = {
  pulse: (i) => ({
    opacity: [0, 0.8, 0],
    fill: ["#000000", "#00ff00", "#000000"], // Explicit black -> green -> black as requested
    transition: {
      duration: 2 + Math.random() * 2, // Slower, more deliberate pulse
      repeat: Infinity,
      ease: "easeInOut",
      delay: Math.random() * 3
    }
...
const serverRackLocations = [
  // Column 1
  { x: 427.8, y: 398.6 }, { x: 427.8, y: 428.4 }, { x: 427.8, y: 458.3 },
  // Column 2
  { x: 458.3, y: 397.6 }, { x: 458.3, y: 427.6 }, { x: 458.3, y: 457.5 },
  // Column 3
  { x: 489.0, y: 396.6 }, { x: 489.0, y: 426.7 }, { x: 489.0, y: 456.8 },
  // Column 4
  { x: 519.9, y: 395.6 }, { x: 519.9, y: 425.8 }, { x: 519.8, y: 456.0 },
  // Column 5
  { x: 550.9, y: 394.5 }, { x: 550.9, y: 424.9 }, { x: 550.9, y: 455.3 },
  // Column 6
  { x: 582.1, y: 393.5 }, { x: 582.1, y: 424.0 }, { x: 582.1, y: 454.5 },
  // Column 7
  { x: 613.5, y: 392.4 }, { x: 613.5, y: 423.1 }, { x: 613.5, y: 453.7 },
];

const ServerLights = () => {
  return (
    <motion.g
      id="ServerLights-Animated"
      animate={{
        x: [0, 50, -50, 0], // Move horizontally to prove control
        y: [0, -20, 20, 0], // Slight vertical waver
      }}
      transition={{
        duration: 10,
        repeat: Infinity,
...
const constellationPaths = [
  ...
  "M746,748l194,132l-98,145l90,159l94,-127l112,8l98,-225l135,-7l-1,88l174,-195",
  "M771,1388l72,-362l89,159l94,-128l113,8l97,-224l135,-7l-2,87l174,-196",
  "M1023,1323l-92,-139l94,-126l112,6l97,-223l136,-7l-1,86l175,-194"
];

const testConst = ["M1023,1323l-92,-139l94,-126l112,6l97,-223l136,-7l-1,86l175,-194"];
const testConst2 = ["M770,364l140,134l80,-115l209,80l46,155l125,7l-3,-96l176,192"];
const testConst3 = ["M745,747l183,-80l-76,-222c102.256,97.837 189.601,211.273 287,327l105,-154l126,7l-2,-95l174,191"];
const testConst4 = ["M746,748l194,132l-98,145l90,159l94,-127l112,8l98,-225l135,-7l-1,88l174,-195"];
const testConst5 = ["M771,1388l72,-362l89,159l94,-128l113,8l97,-224l135,-7l-2,87l174,-196"];
const testConst6 = ["M1023,1323l-92,-139l94,-126l112,6l97,-223l136,-7l-1,86l175,-194"];
  ...
  return (
    ...
    >
      ...
      <g id="Server-constellation-safe">
            ...
            <React.Fragment key={`path-${index}`}>
              ...
              <motion.path
                ...
                style={{
                  ...
                  stroke: isHovered ? colors[index % colors.length] : "transparent",
                  strokeWidth: "2px",
                  fillOpacity: 0,
                }}
              ...
              <motion.circle
                ...
                style={{
                  ...
                  offsetDistance: "0%",
                  fill: isHovered ? colors[index % colors.length] : "transparent"
                }}
        ...
        <g id="TestPathAnimation">
          {allTestPaths.map((pathD, index) => (
            <React.Fragment key={`test-path-${index}`}>
              <motion.path
                id={`TestPath${index + 1}`}
                d={pathD}
                style={{
                  fill: "none",
                  stroke: "#00FFFF", // Cyan (Light Blue)
                  strokeWidth: "2px",
                  fillOpacity: 0,
                }}
              ...
              <motion.path
                ...
                style={{
                  fill: "none",
                  stroke: "#00FFFF", // Cyan (Light Blue)
                  strokeWidth: "12px", // Radius ~6
                  strokeLinecap: "round"
                }}
                initial={{ pathLength: 0.001, pathOffset: 0, opacity: 1 }}
                animate={{
                  pathOffset: [0, 1, 1, 1],
                  strokeWidth: ["12px", "90px", "12px"] // Even larger pulse
                }}
                transition={{
                  pathOffset: {
                    duration: 4,
                  ...
                  strokeWidth: {
                    duration: 2.5, // Slightly slower for dramatic effect
                    repeat: Infinity,
                    ease: "easeInOut"
                  }
                }}
