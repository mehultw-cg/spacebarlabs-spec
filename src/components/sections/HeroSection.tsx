...
export function HeroSection() {
  return (
    ...
    <section className="relative hero-background min-h-screen flex items-center justify-center overflow-hidden bg-white dark:bg-black text-black dark:text-white pt-20">
      {/* Background Effects */}
            <Starfield
              speedFactor={0.0075}
            />
